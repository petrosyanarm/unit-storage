  ...
  return (
    <Drawer direction="right" handleOnly>
      <DrawerTrigger asChild>
        <Button className="cursor-pointer max-lg:px-3">Create</Button>
      </DrawerTrigger>
      <DrawerContent className={cn("my-6 mr-6 px-6 pt-6 rounded-2xl flex gap-2", openDimension ? "data-[vaul-drawer-direction=right]:sm:max-w-253.25 grid grid-cols-2" : "data-[vaul-drawer-direction=right]:sm:max-w-131.25")}>
